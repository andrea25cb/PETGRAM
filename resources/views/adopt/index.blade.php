        ...
        <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card">
                                <img src="{{ asset('storage/pets/' . $pet->photo) }}" alt="{{ $pet->name }}"
                                    class="card-img-top rounded" height="200px">
                                <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card border-success">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <a href="{{ route('createPet') }}"
                                class="btn btn-warning">{{ __('Add pet for adoption') }}</a>
                        </div>
                        <form method="POST" action="{{ route('adopt.store') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror"
                                    id="email" name="email" placeholder="{{ __('Enter email') }}" required>
                                @error('email')
