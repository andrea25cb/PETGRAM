                        ...
                        <form method="POST" action="{{ route('storePet') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('species') is-invalid @enderror" id="species" name="species" required>
                                    ...
                                    <option value="dog" {{ old('species') == 'dog' ? 'selected' : '' }}>{{ __('Dog') }}</option>
                                    <option value="cat" {{ old('species') == 'cat' ? 'selected' : '' }}>{{ __('Cat') }}</option>
                                    <option value="hamster" {{ old('species') == 'hamster' ? 'selected' : '' }}>{{ __('Hamster') }}</option>
                                    <option value="snake" {{ old('species') == 'snake' ? 'selected' : '' }}>{{ __('Snake') }}</option>
                                    <option value="pig" {{ old('species') == 'pig' ? 'selected' : '' }}>{{ __('Pig') }}</option>
                                    <option value="guineapig" {{ old('species') == 'guineapig' ? 'selected' : '' }}>{{ __('Guinea pig') }}</option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('adopted') is-invalid @enderror" id="adopted" name="adopted" required>
                                    <option value="" disabled selected>{{ __('Select adopted status') }}</option>
                                    <option value="0" {{ old('adopted') == '0' ? 'selected' : '' }}>{{ __('No') }}</option>
                                    <option value="1" {{ old('adopted') == '1' ? 'selected' : '' }}>{{ __('Yes') }}</option>
                                </select>
                                @error('adopted')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
