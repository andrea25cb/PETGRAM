...
@section('content')
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            <a href="{{ route('pets.edit', $pet->id) }}" class="btn btn-info btn-sm"><img
                                                    width="20px"
                                                    src="https://cdn-icons-png.flaticon.com/512/1159/1159633.png"></a>
                                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                                data-target="#confirmDeleteModal{{ $pet->id }}"><img width="20px"
                                                    src="https://cdn-icons-png.flaticon.com/512/1214/1214428.png"></button>
                                        </div>
                                        {{-- <form method="GET" action="{{ route('pets.select', ['pet_id' => $pet->id]) }}"> --}}
    ...
    @verbatim
        <script>
             ...
             * y guardo la sesion para enviar la selección al servidor sin recargar la página.
             */
